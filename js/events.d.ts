...
export declare type EventFn = (...args: any[]) => Promise<any>;
/**
 * Data for an event listener.
 */
export declare class Listener implements Utils.Chainable {
    fn: EventFn;
    context: any;
    once: boolean;
    next: Listener | null;
 ...
 * @returns {Listener}
 */
export declare function addListener(event: string, fn: EventFn, context?: any, once?: boolean): Listener;
/**
 * Add a listener for a given event.
 *
 * @param {String} event The event name.
 ...
 * @returns {Listener}
 */
export declare function on(event: string, fn: EventFn, context?: any, once?: boolean): Listener;
/**
 ...
 * @public
 */
export declare function once(event: string, fn: EventFn, context?: any): Listener;
/**
 ...
 */
export declare function clearEvent(event: string): void;
/**
 ...
 * @public
 */
export declare function emit(...args: any[]): Promise<boolean>;
